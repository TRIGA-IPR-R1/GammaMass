...
# ------------------------------
    ...
    def tallies_fluxo_pulso_detector(
        ...
        if not get:
            ...
            #tally_flux.filters.append(openmc.ParticleFilter(bins='photon'))     # pulse height não aceita ParticleFilter
            ...
            pulse_mean = float(pulse.mean[0][0][0])                        # troquei para pulse.mean
            pulse_std_dev = float(pulse.std_dev[0][0][0])                  # troquei para pulse.std_dev
