...
UPPER_TARUGO_INICIAL = 30.0
UPPER_TARUGO_FINAL= -20.0
...
while UPPER_TARUGO >= UPPER_TARUGO_FINAL:
    ...
    materials = openmc.Materials([cobalto, aco, csi, agua, ar, carvao, ore])
 ...
 ###############################################
    ...
    ar_region = (-plane_y_max_vazio & +plane_y_min_vazio & -plane_x_max_vazio & +plane_x_min_vazio & -plane_z_max_vazio &  +plane_z_min_vazio &
                ~detector_cell.region & ~tarugo_cell.region & ~fonte_cell.region & ~esteira_cell.region)
